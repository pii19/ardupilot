...
bool OGR_SensorTempMotor_ADS1015_S8120C::get_reading(void)
{
    be16_t val;
    int ival;
	bool ret=false;
...
int OGR_SensorTempMotor_ADS1015_S8120C::convert(be16_t val)
{
    uint16_t uval;
    int ival;
...
bool OGR_SensorTempMotor_ADS1015_S8120C::get_ADS1015(uint8_t ch, be16_t &val)
{
    bool ret=false;
